...
export default function ComplaintsPage() {
  return (
    <>
      <PageHeader title="Complaints" description="Prioritize, assign, comment, and resolve student service requests." action="Assign Work" />
      <LiveDataTable<Complaint> endpoint="/admin/complaints" fallbackData={complaints as Complaint[]} mapRow={(row) => ({
        id: String(row.id),
